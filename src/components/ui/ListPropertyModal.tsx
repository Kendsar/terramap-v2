...
export function ListPropertyModal({ isOpen, onOpenChange, coordinates, onSuccess }: ListPropertyModalProps) {
  ...
  const inputClass = "w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-gray-100 placeholder:text-gray-600 focus:border-emerald-500 focus:bg-white/10 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all";
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] z-[2000] flex max-h-[85vh] w-full max-w-[640px] translate-x-[-50%] translate-y-[-50%] flex-col overflow-hidden rounded-3xl border border-white/10 bg-[#15181e] shadow-2xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95">
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
            ...
            <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[1.5px] text-gray-500 mt-1">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* Type */}
              <div>
                <label className="text-xs font-semibold text-gray-400 mb-1.5 block">Property Type *</label>
              ...
              {/* Image URL (optional) */}
              <div className="col-span-2">
                <label className="text-xs font-semibold text-gray-400 mb-1.5 block">Cover Image URL <span className="text-gray-600">(optional)</span></label>
            ...
            <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-[1.5px] text-gray-500 border-t border-white/10 pt-5 mt-1">
